      ...
      <div class="modal-body">
       <form role="form" action="<?= base_url('penyakit/simpan');?>" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="deskripsi" placeholder="Deskripsi Penyakit">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Terapi</label>
          <select class="form-control" name="id_terapi">
      ...
      <div class="modal-body">
       <form role="form" action="<?= base_url('penyakit/simpan');?>" method="post">
        <div class="card-body">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Penyakit</label>
            <input type="text" class="form-control" name="penyakit" id="penyakit" placeholder="Nama Penyakit">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Deskripsi</label>
          ...
          <div class="form-group">
            <label for="exampleInputPassword1">Terapi</label>
            <select class="form-control" id="id_terapi" name="id_terapi">
              <option>--Pilih Terapi--</option>
              <?php
              foreach ($terapi as $data) {
                echo "<option value='$data->id_terapi'>$data->terapi</option>";
