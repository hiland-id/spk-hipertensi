            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?= $data->terapi; ?></td>
                  <td>
                    <a href="javascript:;" data-id_terapi='<?= $data->id_terapi; ?>' data-terapi='<?= $data->terapi; ?>' class="btn btn-primary edit">
                      Edit
                    </a>
        ...
        <form role="form" action="<?= base_url('terapi/simpan'); ?>" method="post">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="id_terapi" placeholder="Input Kode terapi" required>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Nama terapi</label>
              <input type="text" class="form-control" name="terapi" placeholder="Input Nama terapi" required>
            </div>
          </div>
          <!-- /.card-body -->
      </div>
      ...
      <div class="modal-body">
        <form role="form" action="<?= base_url('terapi/simpan'); ?>" method="post">
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Nama terapi</label>
              <input type="text" class="form-control" name="terapi" id="terapi" placeholder="Input Nama terapi" required>
            </div>
          </div>
          <!-- /.card-body -->
